namespace AutoPremium.Telas
{
    partial class InfGerais
    {
        ...
        private void InitializeComponent()
        {
            ...
            tb_marcaVei = new TextBox();
            tb_modeloVei = new TextBox();
            tb_anoFab = new TextBox();
            tb_anoMod = new TextBox();
            tb_numeroPort = new TextBox();
            ...
            botao_fechar.Location = new Point(676, 9);
            ...
            botao_limpar.Location = new Point(12, 371);
            botao_limpar.Name = "botao_limpar";
            botao_limpar.Size = new Size(131, 37);
            botao_limpar.TabIndex = 2;
            botao_limpar.UseVisualStyleBackColor = true;
            // 
            // botao_proximo
            // 
            botao_proximo.Cursor = Cursors.Hand;
            botao_proximo.Location = new Point(583, 371);
            botao_proximo.Name = "botao_proximo";
            botao_proximo.Size = new Size(132, 37);
            botao_proximo.TabIndex = 3;
            botao_proximo.UseVisualStyleBackColor = true;
            botao_proximo.Click += botao_proximo_Click;
            // 
            // tb_marcaVei
            // 
            tb_marcaVei.BorderStyle = BorderStyle.None;
            tb_marcaVei.Font = new Font("Segoe UI", 10.2F, FontStyle.Regular, GraphicsUnit.Point, 0);
            tb_marcaVei.Location = new Point(12, 123);
            tb_marcaVei.Name = "tb_marcaVei";
            tb_marcaVei.Size = new Size(315, 23);
            tb_marcaVei.TabIndex = 4;
            // 
            // tb_modeloVei
            // 
            tb_modeloVei.BorderStyle = BorderStyle.None;
            tb_modeloVei.Font = new Font("Segoe UI", 10.2F, FontStyle.Regular, GraphicsUnit.Point, 0);
            tb_modeloVei.Location = new Point(396, 123);
            tb_modeloVei.Name = "tb_modeloVei";
            tb_modeloVei.Size = new Size(315, 23);
            tb_modeloVei.TabIndex = 5;
            // 
            // tb_anoFab
            // 
            tb_anoFab.BorderStyle = BorderStyle.None;
            tb_anoFab.Font = new Font("Segoe UI", 10.2F, FontStyle.Regular, GraphicsUnit.Point, 0);
            tb_anoFab.Location = new Point(12, 173);
            ...
            // tb_anoMod
            // 
            tb_anoMod.BorderStyle = BorderStyle.None;
            tb_anoMod.Font = new Font("Segoe UI", 10.2F, FontStyle.Regular, GraphicsUnit.Point, 0);
            tb_anoMod.Location = new Point(177, 173);
            ...
            // tb_numeroPort
            // 
            tb_numeroPort.BorderStyle = BorderStyle.None;
            tb_numeroPort.Font = new Font("Segoe UI", 10.2F, FontStyle.Regular, GraphicsUnit.Point, 0);
            tb_numeroPort.Location = new Point(12, 223);
            tb_numeroPort.Name = "tb_numeroPort";
            tb_numeroPort.Size = new Size(315, 23);
            tb_numeroPort.TabIndex = 8;
            tb_numeroPort.KeyPress += tb_numeroPort_KeyPress;
            // 
            // rb_sedan
            // 
            rb_sedan.AutoSize = true;
            rb_sedan.BackColor = Color.Transparent;
            rb_sedan.ForeColor = SystemColors.Window;
            ...
            rb_hatch.ForeColor = SystemColors.Window;
            ...
            rb_perua.ForeColor = SystemColors.Window;
            ...
            rb_suv.ForeColor = SystemColors.Window;
            ...
            rb_cupe.ForeColor = SystemColors.Window;
            ...
            rb_fastback.ForeColor = SystemColors.Window;
            ...
            rb_targa.ForeColor = SystemColors.Window;
            ...
            rb_roadster.ForeColor = SystemColors.Window;
            ...
            rb_minivan.ForeColor = SystemColors.Window;
            ...
            rb_van.ForeColor = SystemColors.Window;
            ...
            rb_branco.ForeColor = SystemColors.Window;
            ...
            rb_preto.ForeColor = SystemColors.Window;
            ...
            rb_cinza.ForeColor = SystemColors.Window;
            ...
            rb_prata.ForeColor = SystemColors.Window;
            ...
            rb_vermelho.ForeColor = SystemColors.Window;
            ...
            rb_azul.ForeColor = SystemColors.Window;
            rb_azul.Location = new Point(105, 32);
            ...
            // rb_rosa
            // 
            rb_rosa.AutoSize = true;
            rb_rosa.BackColor = Color.Transparent;
            rb_rosa.ForeColor = SystemColors.Window;
            rb_rosa.Location = new Point(170, 32);
            rb_rosa.Name = "rb_rosa";
            rb_rosa.Size = new Size(62, 24);
            rb_rosa.TabIndex = 25;
            rb_rosa.TabStop = true;
            rb_rosa.Text = "Rosa";
            rb_rosa.UseVisualStyleBackColor = false;
            // 
            // rb_verde
            // 
            rb_verde.AutoSize = true;
            rb_verde.BackColor = Color.Transparent;
            rb_verde.ForeColor = SystemColors.Window;
            rb_verde.Location = new Point(238, 32);
            ...
            groupBox1.Location = new Point(396, 161);
            ...
            groupBox2.Controls.Add(rb_rosa);
            ...
            BackgroundImage = Properties.Resources.Cadastro_carro;
            ClientSize = new Size(727, 430);
            Controls.Add(groupBox2);
            Controls.Add(groupBox1);
            Controls.Add(tb_numeroPort);
            Controls.Add(tb_anoMod);
            Controls.Add(tb_anoFab);
            Controls.Add(tb_modeloVei);
            Controls.Add(tb_marcaVei);
        ...
        private TextBox tb_marcaVei;
        private TextBox tb_modeloVei;
        private TextBox tb_anoFab;
        private TextBox tb_anoMod;
        private TextBox tb_numeroPort;
